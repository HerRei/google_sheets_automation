...
def test_append_entry_calculates_row(monkeypatch):
    ...
    assert mock_service.calls[1][1] == "Record Type A!A3:E3"
...
def test_wizard_flow(client, monkeypatch):
    ...
    # Step 4: Details (leave number blank)
    ...
    assert saved_data[0]['target'] == "Target A"
    assert saved_data[0]['reference'] is None
